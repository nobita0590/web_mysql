		...
		editor.addCommand('simage', {
			exec: function (editor) {
				...
				a.onchange = function(){
					...
					loaderHtmlStr = '<div style="position: relative; z-index: 100;width: 100%;height: 100%;text-align: center;background: white;opacity: 0.75;pointer-events:none">' + '<img src="/public/assets/img/avatars/6.jpg" style="width: 30px;height: 30px;margin-top: 100px;">' + '</div>'
